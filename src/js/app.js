...
function iniciarApp() {
    ...
    tabs();//cambiar la funcion de los tabs
    botonesPaginador();//funcion para activar los paginadores
    paginaSiguiente();
    paginaAnterior();
...
function mostrarSeccion() {
    ...
    const dataPaso = `[data-paso="${paso}"]`
    const tab = document.querySelector(dataPaso);
...
function mostrarAlerta(mensaje, tipo, elemento, desaparece = true) {
    //Previene que se muestre mas de una alerta
...
function mostrarResumen() {
    ...
    //Encabezado para Servicios en Resumen
    ...
    //Encabezado para cita en Resumen
